...
<head>
    ...
    <title>ABSEN DULU | Registration Page</title>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('nik') ? ' has-error' : '' }}">
                <input type="number" class="form-control" name="nik" value="{{ old('nik') }}" placeholder="NIK Bistel">
...
<!-- AdminLTE App -->
<script src="{{asset('/lte3/dist/js/adminlte.min.js')}}x"></script>
<script>
    $(function () {
        $('input').iCheck({
